  ...
  commands: {
    ...
    product: {
      ...
      outputFields: {
        ...
        "shipping.free": "boolean — buyer pays nothing for delivery",
        "shipping.cost.value": "number | null — null when free",
        "shipping.cost.formatted": "string | null",
        "shipping.daysMin": "number | null — fastest quoted transit",
        "shipping.daysMax": "number | null — slowest quoted transit",
        "shipping.etaFrom": "string | null — localized arrival window",
        "shipping.etaTo": "string | null",
        "shipping.provider": "string | null",
        "shipping.shipsFrom": "string | null",
        "shipping.shipsTo": "string | null",
        "shipping.tracked": "boolean",
      },
